# Лабораторні роботи з дисципліни "Алгоритми та
структури даних"
...
Доп. завдання:
1) загнати функції як методи в класі BinaryTree. Зробити їх в паблік  +
2) зчитати з файлу дерево задане пост ордер треба зроби бінарне +-
3) вивід дерева вигляд зверху
